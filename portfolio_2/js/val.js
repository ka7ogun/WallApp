$(document).ready(function(){
	...
	$("#joinBtn").click(function(){
		...
		if( borough === "" ){
			$("#borough").css("border", "solid 1px red");
		}else{
			borough_valid = validate( "normalString", borough);
		}
		...
		if( firstname_valid && lastname_valid && email_valid && borough_valid && age_valid && occupation_valid){
			$("#wallJoin").submit();
		}else{
